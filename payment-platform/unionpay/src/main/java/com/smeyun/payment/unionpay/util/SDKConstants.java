...
public class SDKConstants {
	...
	/**交易类型 ，01：消费*/
	public static final String TXN_CONSUME = "01";
	/** 交易子类型， 01：自助消费  */
	public static final String TXN_SUB_CONSUME = "01";
	/** 业务类型，B2C网关支付，手机wap支付  */
	public static final String BIZ_B2C = "000201";
	/** 业务类型，B2B网银支付  */
	public static final String BIZ_B2B = "000202";
	/** 区分B2C网关支付和手机wap支付  07：PC */
	public static final String CHNANEL_PC = "07";
	/** 区分B2C网关支付和手机wap支付  07：手机 */
	public static final String CHNANEL_MOBILE = "08";
	/** 接入类型，0：直连商户 */
	public static final String ACCESS_MERCHANT = "0";
	/** 交易币种（境内商户一般是156 人民币） */
	 ...
	 * 支付成功
	 */
	public static final String PAY_SUCESS = "00";
	/**
	 * 支付处理中
	 */
	 ...
	 * 支付失败
	 */
	public static final String PAY_FAILED = "02";
